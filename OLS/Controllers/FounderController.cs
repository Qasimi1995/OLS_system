...
namespace OLS.Controllers
{
    ...
    public class FounderController : Controller
    {
        ...
        public IActionResult Navigate(string? newSchool,string? mySchoolId)
        {
            ...
            {
                founder = _applicationContext.Person.Where(p => p.CreatedBy == UserId && p.SchoolId == schoolid && p.PartyRoleTypeId == Guid.Parse("CAE7466D-198A-423B-903F-BB64D58C0236")).FirstOrDefault();
